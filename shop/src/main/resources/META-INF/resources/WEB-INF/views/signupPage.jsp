    ...
    <div class="container">
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item"><a class="nav-link" href="/login"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-cart3" viewBox="0 0 16 16">
            ...
            <div class="input-form col-md-12 mx-auto">
                <form method="post" action="/signup" class="validation-form" novalidate>
                    ...
                    <section class="btn-section">
                        <button class="btn btn-primary btn-block signbtn" type="submit">회원가입</button>
                    </section>
                </form>
            </div>
        </div>
